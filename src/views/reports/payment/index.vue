<template>
  <div class="payment-report-page">
    ...
    <el-tabs v-model="activeTab" @tab-change="handleTabChange">
      ...
      <el-tab-pane label="商户通道日报表" name="channel"></el-tab-pane>
    </el-tabs>
...
const handleExport = async () => {
  try {
    ...
    if (activeTab.value === 'daily') {
      exportUrl = '/pay-report/payment-order-daily/export'
      fileNamePrefix = 'payment_daily_report'
    } else if (activeTab.value === 'channel') {
      exportUrl = '/pay-report/payment-channel-daily/export'
      fileNamePrefix = 'payment_channel_daily_report'
    } else if (activeTab.value === 'monthly') {
      exportUrl = '/pay-report/payment-order-daily/export-month'
      fileNamePrefix = 'payment_monthly_report'
    }
