<template>
  <div class="pend-line-report-page">
    <!-- 页面标题 -->
    <div class="page-header">
      <h2 class="page-title">待线报表</h2>
    </div>
    ...
    <el-card class="table-card" shadow="never">
      ...
      >
        <el-table-column prop="platformId" label="代付平台ID" width="120" />
        <el-table-column prop="platformName" label="代付平台名称" width="180" />
        <el-table-column prop="statsDate" label="统计日期" width="120" />

        <el-table-column label="支付总额" width="150" align="right">
        ...
        <el-table-column label="平均出款耗时" width="150" align="right">
          <template #default="{ row }">
            <span style="color: #409EFF;">
              {{ row.averageWithdrawalMinute?.toFixed(0) }} 分钟
            </span>
          </template>
        </el-table-column>
...
const handleExport = async () => {
  try {
    ...
    if (activeTab.value === 'daily') {
      exportUrl = '/pay-report/payout-platform-daily/export'
      fileNamePrefix = 'pend_line_daily_report'
    } else if (activeTab.value === 'monthly') {
      exportUrl = '/pay-report/payout-platform-daily/export-month'
      fileNamePrefix = 'pend_line_monthly_report'
    }
