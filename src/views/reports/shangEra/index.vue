<template>
  <div class="shang-era-report-page">
    <!-- 页面标题 -->
    <div class="page-header">
      <h2 class="page-title">商代报表</h2>
    </div>
    ...
    <el-card class="table-card" shadow="never">
      ...
      >
        ...
        <el-table-column prop="merchantAccount" label="商户账号" width="180" />
        <el-table-column prop="statsDate" label="统计日期" width="120" />

        <el-table-column label="支付佣金" width="200" align="right">
        ...
        <el-table-column label="代付佣金" width="200" align="right">
          <template #default="{ row }">
        ...
        <el-table-column label="佣金合计" width="200" align="right">
          <template #default="{ row }">
            <span style="color: #E6A23C; font-weight: 600;">
              {{ ((row.paymentCommission || 0) + (row.payoutCommission || 0)).toFixed(2) }}
            </span>
          </template>
        </el-table-column>
      </el-table>
    ...
    switch (column.property) {
      ...
      default:
        ...
        if (index === columns.length - 1) {
          const totalCommission = summaryData.totalPaymentCommission + summaryData.totalPayoutCommission
          sums[index] = totalCommission.toFixed(2)
        } else {
          sums[index] = ''
        }
    }
...
const handleExport = async () => {
  try {
    ...
    if (activeTab.value === 'daily') {
      exportUrl = '/pay-report/merchant-commission/export'
      fileNamePrefix = 'shang_era_daily_report'
    } else if (activeTab.value === 'monthly') {
      exportUrl = '/pay-report/merchant-commission/export-month'
      fileNamePrefix = 'shang_era_monthly_report'
    }
