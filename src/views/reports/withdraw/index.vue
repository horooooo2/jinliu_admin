<template>
  <div class="withdraw-report-page">
    <!-- 页面标题 -->
    <div class="page-header">
      <h2 class="page-title">提现报表</h2>
    </div>
...
const handleExport = async () => {
  try {
    ...
    if (activeTab.value === 'daily') {
      exportUrl = '/pay-report/withdrawal-order-daily/export'
      fileNamePrefix = 'withdraw_daily_report'
    } else if (activeTab.value === 'monthly') {
      exportUrl = '/pay-report/withdrawal-order-daily/export-month'
      fileNamePrefix = 'withdraw_monthly_report'
    }
