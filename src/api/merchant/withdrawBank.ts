...
// 提现银行编辑名称
export const editMerchantWithdrawalBankName = (params: MerchantPayoutBankEditNameParams) => {
  return request.put('/pay-bank/withdrawal-bank/edit-name', { params })
}

// 提现银行编辑排序
export const editMerchantWithdrawalBankSort = (params: MerchantPayoutBankEditSortParams) => {
  return request.put('/pay-bank/withdrawal-bank/edit-sort', { params })
}
